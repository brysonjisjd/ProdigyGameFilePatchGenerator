        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                patches = [
                    [
                        /s\),this\._game=(.)/,
                        "s),this._game=$1;Object.defineProperty(window._, \"game\", {get: () => this._game, enumerable: true, configurable: true});Object.defineProperty(window._, \"instance\", {get: () => ".concat(variables[0], ".instance, enumerable: true, configurable: true});Object.defineProperty(window._, \"player\", {get: () => window._.").concat((_a = gameFile.match(/instance.prodigy.gameContainer.get\("...-...."\).player/)) === null || _a === void 0 ? void 0 : _a[0], ", enumerable: true, configurable: true});Object.defineProperty(window._, \"gameData\", {get: () => ").concat(variables[0], ".instance.game.state.states.get(\"Boot\")._gameData, enumerable: true, configurable: true});Object.defineProperty(window._, \"localizer\", {get: () => ").concat(variables[0], ".instance.prodigy.gameContainer.get(\"LocalizationService\"), enumerable: true, configurable: true});Object.defineProperty(window._, \"network\", {get: () => window._.player.game.input.onDown._bindings[0].context, enumerable: true, configurable: true});")
                    ],
                    [
                        /(.)\.constants=Object/,
